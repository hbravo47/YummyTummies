class RegistersController < ApplicationController
  ...
  def show
    @registers = Register.all
    @school = User.all.where(:typeacct =>2)
  end
  ...
  def create
    ...
    @register.update_attribute(:user_id, @id)
    @register.update_attribute(:approved, false)
  ...
  private
    ...
    def register_params
      params.require(:register).permit(:name, :address, :school, :phone, :kids, :kidsId, :user_id)
    end
end
